...
document.addEventListener('DOMContentLoaded', async function() {
    let loginPage = await loadTemplate('/pages/login/login.html');
...
async function loadLoginForm() {
    let loginForm = await loadTemplate('/pages/login/login-form.html');
    loadTitle(loginForm);
...
async function loadUsernameTextField(loginForm) {
    let input = await loadTemplate('/pages/login/input/input.html');
